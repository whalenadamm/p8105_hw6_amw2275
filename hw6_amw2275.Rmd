...
Cool, now let's examine the distribution of both $\hat r^2$ and $log(\hat \beta_0 * \hat \beta_1)$. 
...
The distribution of $log(\hat \beta_0 * \hat \beta_1)$ appears to be bimodal, with peaks around 1.996 and again at 2.03, but has a very tight distribution, as the range is from about 1.984 to 2.062. The distribution of $\hat r^2$ appears to be relatively normal, with a peak near 0.91 and a slight left-skewness. 
