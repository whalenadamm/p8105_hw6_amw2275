...
Cool, now let’s examine the distribution of both \(\hat r^2\) and
...
The distribution of \(log(\hat \beta_0 * \hat \beta_1)\) appears to be
bimodal, with peaks around 1.996 and again at 2.03, but has a very tight
distribution, as the range is from about 1.984 to 2.062. The
distribution of \(\hat r^2\) appears to be relatively normal, with a
peak near 0.91 and a slight left-skewness.
...
| r\_ci\_lower | r\_ci\_upper | b\_ci\_lower | b\_ci\_upper |
| -----------: | -----------: | -----------: | -----------: |
|    0.8971014 |    0.9263476 |      1.95846 |     2.055063 |
